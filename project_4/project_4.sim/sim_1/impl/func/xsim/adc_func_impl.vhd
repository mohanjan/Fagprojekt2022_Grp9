...
-- Date        : Mon Mar  7 11:15:30 2022
-- Host        : DESKTOP-K43AEQ4 running 64-bit major release  (build 9200)
-- Command     : write_vhdl -mode funcsim -nolib -force -file
--               C:/Users/Gamerpcen/Desktop/project_4/project_4.sim/sim_1/impl/func/xsim/adc_func_impl.vhd
-- Design      : adc
...
entity adc is
  ...
  attribute ECO_CHECKSUM of adc : entity is "a65be069";
end adc;

architecture STRUCTURE of adc is
  signal JA_IBUF : STD_LOGIC_VECTOR ( 4 downto 0 );
...
\JA_IBUF[4]_inst\: unisim.vcomponents.IBUF
     port map (
      I => JA(4),
      O => JA_IBUF(4)
    );
